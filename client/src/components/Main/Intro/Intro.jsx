  ...
  return (
    <header className={`${styles.intro} ${projectIsVisible ? styles.projectIsVisible : ''}`}>
      ...
      <section className={styles.intro_copy}>
        <h1>
          My name's Sam. I'm a full stack developer from London and this is the best place on the whole of the internet to see examples of <a href="#projects"><span>my</span><span> work</span></a> and discover a bit <a href="#about"><span>about</span><span> me</span></a>.
        </h1>
      </section>
    </header>
  );
